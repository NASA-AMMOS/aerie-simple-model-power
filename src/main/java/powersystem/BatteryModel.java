...
public class BatteryModel {
    ...
    /**
     * Voltage the spacecraft uses to distribute power to its various components (V). Also known as battery bus
     * voltage
     */
    ...
    public DerivedState<Double> powerProduction;    //the source power, how much solar power the spacecraft is generating
    ...
    public BatteryModel(String name, BatterySimConfig batterySimConfig, Resource<Double> totalLoad, Resource<Double> powerProduction) {
        ...
        this.batteryCapacityAH = simConfig.busVoltage();
        ...
        this.batteryPower = DerivedState.builder(Double.class)
                .sourceStates(this.powerProduction, this.powerDemand)
                .valueFunction(this::computeNetPowerW)
                .build();
        this.netPower = DerivedState.builder(Double.class)
...
//    }
    ...
    public double netPowerWBattery() {
        double net = (powerProduction.get() - powerDemand.get()) / 3600;
        if (startOfSim == true) {
            startOfSim = false;
    ...
    */
    ...
    public void registerStates(Registrar registrar) {
        registrar.discrete(name + "battery.netPower", netPower, new DoubleValueMapper());
        registrar.discrete(name + "battery.batteryPower", batteryPower, new DoubleValueMapper());
