...
public class BatteryModel {
    ...
    public Resource<Polynomial> batteryCurrentUnclamped;  // State of charge of the battery (%)
    ...
    public Resource<Polynomial> powerProduction;

    public BatteryModel(String name, BatterySimConfig batterySimConfig, Resource<Discrete<Double>> totalLoad, Resource<Polynomial> powerProduction) {
        ...
        double battery_charge = this.batteryCapacityAH * this.simConfig.initialSOC() / 100.0;
         ...
         // bus voltage (I = P/V).
        this.batteryCurrentUnclamped = scale( PolynomialResources.subtract(this.powerProduction,
                        asPolynomial(this.powerDemand)), 1/this.busVoltage);

        // Integrated states compute in units of seconds, but battery charge is in units of Amp-hours, hence the
        // factor of 3600
        var clampedIntegrate = PolynomialResources.clampedIntegrate( this.batteryCurrentUnclamped,
...
//        double battery_charge = this.batteryCapacityAH * this.simConfig.initialSOC() / 100.0;
//
//        this.batteryCurrentUnclamped =  map(powerProduction, this.powerDemand, this::computeBatteryCurrent);
//
