...
/**
* This class was created by the pel_java_generator.py script and represents the state(s) of the Telecom as an enum and associates
* a power load amount to each state.
*/
public enum Telecom_State {
	OFF(0.0, 0.0),
	ON(175.0, 190.0);
    private final double cbeload;
    private final double mevload;
    Telecom_State(double cbeload, double mevload) {
