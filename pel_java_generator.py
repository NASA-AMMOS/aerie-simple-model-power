...
nPath = "src/main/java/powersystem"
pelPath = os.path.join(nPath, "PELModel.java")
pelFile = open(pelPath, "w")
initial = f"""package powersystem;
...
"""
for item in powerList:
    initial = initial + "import demosystem.models.pel." + item["name"] + "_State;\n" 
