...
data = json.load(file)
path = "src/main/java/genericpowersystem/models/pel"
...
for item in powerList:
    ...
    body = f"""package genericpowersystem.models.pel;
...
initial = f"""package genericpowersystem.models.pel;

import gov.nasa.jpl.aerie.merlin.framework.Registrar;
import gov.nasa.jpl.aerie.contrib.serialization.mappers.EnumValueMapper;
import genericpowersystem.models.power.SettableState;
