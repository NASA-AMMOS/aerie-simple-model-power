...
public final class TurnOnTelecommMapper implements ActivityMapper<Mission, TurnOnTelecomm, Unit> {
  private final Topic<TurnOnTelecomm> inputTopic = new Topic<>();

  private final Topic<Unit> outputTopic = new Topic<>();

  @Override
  public InputType<TurnOnTelecomm> getInputType() {
  ...
  @Override
  public Topic<TurnOnTelecomm> getInputTopic() {
  ...
  @Override
  public TaskFactory<Unit> getTaskFactory(final Mission model, final TurnOnTelecomm activity) {
  ...
  @Generated("gov.nasa.jpl.aerie.merlin.processor.MissionModelProcessor")
  public final class InputMapper implements InputType<TurnOnTelecomm> {
    ...
    @Override
    public Map<String, SerializedValue> getArguments(final TurnOnTelecomm input) {
    ...
    @Override
    public TurnOnTelecomm instantiate(final Map<String, SerializedValue> arguments) throws
        InstantiationException {
      final var template = new TurnOnTelecomm();
      Optional<Long> duration = Optional.ofNullable(template.duration);

      final var instantiationExBuilder = new InstantiationException.Builder("TurnOnTelecomm");
    ...
    @Override
    public List<InputType.ValidationNotice> getValidationFailures(final TurnOnTelecomm input) {
