...
public final class ChangeGNCStateMapper implements ActivityMapper<Mission, ChangeGNCState, Unit> {
  private final Topic<ChangeGNCState> inputTopic = new Topic<>();

  private final Topic<Unit> outputTopic = new Topic<>();

  @Override
  public InputType<ChangeGNCState> getInputType() {
  ...
  @Override
  public Topic<ChangeGNCState> getInputTopic() {
  ...
  @Override
  public TaskFactory<Unit> getTaskFactory(final Mission model, final ChangeGNCState activity) {
  ...
  @Generated("gov.nasa.jpl.aerie.merlin.processor.MissionModelProcessor")
  public final class InputMapper implements InputType<ChangeGNCState> {
    ...
    @Override
    public Map<String, SerializedValue> getArguments(final ChangeGNCState input) {
    ...
    @Override
    public ChangeGNCState instantiate(final Map<String, SerializedValue> arguments) throws
        InstantiationException {
      final var template = new ChangeGNCState();
      Optional<Long> duration = Optional.ofNullable(template.duration);

      final var instantiationExBuilder = new InstantiationException.Builder("ChangeGNCState");
    ...
    @Override
    public List<InputType.ValidationNotice> getValidationFailures(final ChangeGNCState input) {
