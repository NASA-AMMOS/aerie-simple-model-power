...
public final class SolarPowerGenerationMapper implements ActivityMapper<Mission, SolarPowerGeneration, Unit> {
  private final Topic<SolarPowerGeneration> inputTopic = new Topic<>();

  private final Topic<Unit> outputTopic = new Topic<>();

  @Override
  public InputType<SolarPowerGeneration> getInputType() {
  ...
  @Override
  public Topic<SolarPowerGeneration> getInputTopic() {
  ...
  @Override
  public TaskFactory<Unit> getTaskFactory(final Mission model,
  ...
  @Generated("gov.nasa.jpl.aerie.merlin.processor.MissionModelProcessor")
  public final class InputMapper implements InputType<SolarPowerGeneration> {
    ...
    @Override
    public Map<String, SerializedValue> getArguments(final SolarPowerGeneration input) {
    ...
    @Override
    public SolarPowerGeneration instantiate(final Map<String, SerializedValue> arguments) throws
        InstantiationException {
      final var template = new SolarPowerGeneration();
      Optional<Long> duration = Optional.ofNullable(template.duration);

      final var instantiationExBuilder = new InstantiationException.Builder("SolarPowerGeneration");
    ...
    public List<InputType.ValidationNotice> getValidationFailures(
        final SolarPowerGeneration input) {
